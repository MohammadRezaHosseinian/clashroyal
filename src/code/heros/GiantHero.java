...
public class GiantHero extends BaseHero implements Fightable, CanMakeSound, CanWalk, DieAble{

    public GiantHero(ImageView imageView, int hp, Position pos, Speed speed) {
