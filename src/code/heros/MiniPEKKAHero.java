...
public class MiniPEKKAHero extends BaseHero implements Fightable, CanMakeSound, CanWalk, DieAble{

    public MiniPEKKAHero(ImageView imageView, int hp, Position pos, Speed speed) {
