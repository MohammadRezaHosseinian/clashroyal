...
public class ArchersHero extends BaseHero implements Fightable, CanMakeSound, CanWalk, DieAble{

    public ArchersHero(ImageView imageView, int hp, Position pos, Speed speed) {
