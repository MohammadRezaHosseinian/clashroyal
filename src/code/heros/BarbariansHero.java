...
public class BarbariansHero extends BaseHero implements Fightable, CanMakeSound, CanWalk, DieAble{

    public BarbariansHero(ImageView imageView, int hp, Position pos, Speed speed) {
